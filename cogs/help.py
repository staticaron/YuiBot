...
class HelpCommand(commands.Cog):
    ...
    helps = {
        ...
        "list anime": "Returns the provided list from your or any other anilist account. ```yui anime <list_name> [user_name]\n\nyui anime dropped\nyui anime planning\nyui anime fav\nyui anime watching @user```",
        "list manga": "Returns the provided list from your or any other anilist account. ```yui manga <list_name>[user_name]\n\nyui manga dropped\nyui manga reading\nyui manga fav\nyui manga completed @user```",
